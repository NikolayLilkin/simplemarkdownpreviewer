        ...
        return (
            <div className={this.props.length} id="toolbar">
                <div className="col-11">
                    <img src="https://gists.rawgit.com/Deftwun/e3756a8b518cbb354425/raw/6584db8babd6cbc4ecb35ed36f0d184a506b979e/free-code-camp-logo.svg" width="20.58" height="16" className="image"/>
                    {this.props.text}   
                </div>
